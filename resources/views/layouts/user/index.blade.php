                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item" style="cursor: pointer"><a class="nav-link"
                                    onclick="alert('comming soon')">Tiket</a></li>
                            <li class="nav-item" style="cursor: pointer"><a class="nav-link"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="{{ asset('assets/user/img/product/coming.jpg') }}"
                                alt="">
        ...
        {{-- <div class="single-product-slider">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="{{ asset('assets/user/img/product/p6.jpg') }}"
                                alt="">
                            <div class="product-details">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="{{ asset('assets/user/img/product/p8.jpg') }}"
                                alt="">
                            <div class="product-details">
                                <h6>addidas New Hammer sole
                                    for Sports person</h6>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="{{ asset('assets/user/img/product/p3.jpg') }}"
                                alt="">
                            <div class="product-details">
                                <h6>addidas New Hammer sole
                                    for Sports person</h6>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="{{ asset('assets/user/img/product/p5.jpg') }}"
                                alt="">
                            <div class="product-details">
                                <h6>addidas New Hammer sole
                                    for Sports person</h6>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="{{ asset('assets/user/img/product/p1.jpg') }}"
                                alt="">
                            <div class="product-details">
                                <h6>addidas New Hammer sole
                                    for Sports person</h6>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-product">
                            <img class="img-fluid" src="{{ asset('assets/user/img/product/p4.jpg') }}"
                                alt="">
                            <div class="product-details">
                                <h6>addidas New Hammer sole
                                    for Sports person</h6>
                ...
                <div class="col-lg-3  col-md-6 col-sm-6">
                    <div class="single-footer-widget mail-chimp">
                        ...
                        <ul class="instafeed d-flex flex-wrap">
                            <li><img src="{{ asset('assets/user/img/i1.jpg') }}" alt=""></li>
                            <li><img src="{{ asset('assets/user/img/i2.jpg') }}" alt=""></li>
                            <li><img src="{{ asset('assets/user/img/i3.jpg') }}" alt=""></li>
                            <li><img src="{{ asset('assets/user/img/i4.jpg') }}" alt=""></li>
                            <li><img src="{{ asset('assets/user/img/i5.jpg') }}" alt=""></li>
                            <li><img src="{{ asset('assets/user/img/i6.jpg') }}" alt=""></li>
                            <li><img src="{{ asset('assets/user/img/i7.jpg') }}" alt=""></li>
                            <li><img src="{{ asset('assets/user/img/i8.jpg') }}" alt=""></li>
                        </ul>
                    </div>
                </div>
