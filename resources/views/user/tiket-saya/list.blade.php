...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            @if ($transaksi == '[]')
                <h4 class="alert alert-danger w-100 text-center">Anda belum membeli tiket apapun! <a
                        href="/jadwal-tiket">Beli Sekarang</a></h4>
            @else
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <strong>Pertandingan:</strong> {{ $transaksi->tiket->jadwal_pertandingan->club1->nama }}
                                    VS
